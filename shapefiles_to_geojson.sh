...
ZCTA_ZIP_FILENAME=cb_2016_us_zcta510_500k.zip
ZCTA_SHAPEFILE_URL=http://www2.census.gov/geo/tiger/GENZ2016/shp/$ZCTA_ZIP_FILENAME
ZCTA_SHAPEFILE_NAME=cb_2016_us_zcta510_500k.shp
ZCTA_OUT_FILENAME=zip_code_tabulation_areas.geojson
...
download_and_unzip_shapefile $ZCTA_SHAPEFILE_URL $ZCTA_ZIP_FILENAME $TEMP_DIR

rm -f $FRRC_DATA_DIR/$ZCTA_OUT_FILENAME
ogr2ogr -f GeoJSON -t_srs EPSG:4326 $FRRC_DATA_DIR/$ZCTA_OUT_FILENAME $TEMP_DIR/$ZCTA_SHAPEFILE_NAME
